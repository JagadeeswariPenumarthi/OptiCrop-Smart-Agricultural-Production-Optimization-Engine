...
Flask web application that serves the crop recommendation model.

Routes:
    /              Home page
    /about         About page (objectives & methodology)
    /findyourcrop  Input form for crop prediction
    /predict       Handles form submission and returns the prediction
"""
